...
function saludar(elementoUsuario){
    const nombre = elementoUsuario.nombre;
    const apellido = elementoUsuario.apellido;
    const edad = elementoUsuario.edad;
...
function saludar({apellido, edad, nombre}){
    console.log('El nombre es: ', nombre);
    console.log('El apellido es: ', apellido, edad);
}
...
const { lastName, username, ...restantes } = personDos;
console.log(lastName, username, restantes);
